...
public class DealPriceBooking {
  ...
  public void onCreate() {
    ...
    if (usedWashes == null || usedWashes < 0) {
      usedWashes = 0;
    }
  ...
  public Integer getUsedWashes() {
    return usedWashes;
  }

  public void setUsedWashes(Integer usedWashes) {
    this.usedWashes = usedWashes;
  }

  public Integer getLeftWashes() {
    return leftWashes;
  }
